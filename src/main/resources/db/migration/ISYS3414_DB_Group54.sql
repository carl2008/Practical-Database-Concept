...
DROP DATABASE IF EXISTS ISYS3414_DB_GROUP54;
CREATE DATABASE ISYS3414_DB_GROUP54;
USE ISYS3414_DB_GROUP54;
...
CREATE TABLE `booking` (
    ...
    CONSTRAINT `FKcjjayx1872fri8h389m3l26td` FOREIGN KEY (`timetable_id`) REFERENCES `timetable` (`id`) ON DELETE CASCADE,
...
CREATE TABLE `timetable` (
  ...
  CONSTRAINT `FKjpcdoj1icflt8hoggq75vvq1w` FOREIGN KEY (`movie_id`) REFERENCES `movie` (`id`) ON DELETE CASCADE
